 ...
 *
 */
public class AppendCommand extends FastaCommand<SingleOption> {

	public AppendCommand(InputStream inputstream, PrintStream output, SingleOption option) {
	...
	protected List<String> performAction() {
		...
		File rightSequencesFile = (File) this.getOption().getValue();
