 ...
 *
 */
public class IdentityMatrixCommand extends FastaCommand<NoOption> {

	public IdentityMatrixCommand(InputStream inputstream, PrintStream output, NoOption option) {
