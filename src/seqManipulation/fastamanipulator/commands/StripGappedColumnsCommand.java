...
public class StripGappedColumnsCommand extends FastaCommand<NoOption> {

	public StripGappedColumnsCommand(InputStream inputstream, PrintStream output, NoOption option) {
